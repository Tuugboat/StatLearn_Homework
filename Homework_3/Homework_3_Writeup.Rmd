...
```{r PD:Age, echo=F, fig.cap = "The partial effect on age suggests that, as buildings get older, their revenue drops."}
...
```{r PD:Reno, echo=F, fig.cap = "Renovating a building seems to help some at the margin"}
...
```{r PD:CMR, echo=F, fig.cap = "Higher market rent is a strong predictor, and obviously rises the expected returns"}
...
```{r PD:Amen, echo=F, fig.cap = "Having amenities also seems to increase revenue somewhat"}
